...
namespace HighlightPlus
{
    ...
    public class HighlightProfileEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty outline, outlineColor, outlineColorStyle, outlineGradient, outlineGradientInLocalSpace, outlineWidth, outlineBlurPasses, outlineQuality, outlineEdgeMode, outlineEdgeThreshold;
